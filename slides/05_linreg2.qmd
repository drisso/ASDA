...
## Sheldon and Facebook

![](https://tylervigen.com/spurious/correlation/image/4912_popularity-of-the-bazinga-meme_correlates-with_google-searches-for-facebook.svg){fig-align="center"}

## Is this real?

::: {.r-fit-text}

[Let's ask AI!](https://tylervigen.com/spurious/correlation/4912_popularity-of-the-bazinga-meme_correlates-with_google-searches-for-facebook)
...
```{r}
library(ggdag)
dag <- dagify(Bazinga ~~ Facebook, 
              labels = c("Bazinga" = "Bazinga",
                         "Facebook" = "Facebook"))
ggdag(dag, text = FALSE, use_labels = "label", layout="circle") + theme_dag()
```
...
- first solution: add as covariate
- more complex cases: causal inference
...
![](https://lindeloev.github.io/tests-as-linear/linear_tests_cheat_sheet.png){fig-align="center"}
