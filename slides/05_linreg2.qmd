...
## ANOVA and linear regression: two equivalent views
...
y_i = 
\begin{cases}
\beta_0 &\text{if obs. } i \text{ is in group 1} \\
\beta_0 + \beta_1 & \text{if obs. } i \text{ is in group 2} \\
\beta_0 + \beta_2 & \text{if obs. } i \text{ is in group 3}
\end{cases}
$$
...
y_i = 
\begin{cases}
\beta_0 + \beta_3 w_i &\text{if obs. } i \text{ is in group 1} \\
\beta_0 + \beta_1 + \beta_3 w_i & \text{if obs. } i \text{ is in group 2} \\
\beta_0 + \beta_2 + \beta_3 w_i & \text{if obs. } i \text{ is in group 3}
\end{cases}
$$
...
\begin{cases}
\beta_0 + \beta_3 w_i &\text{if obs. } i \text{ is in group 1} \\
(\beta_0 + \beta_1) + (\beta_3 + \beta_4) w_i & \text{if obs. } i \text{ is in group 2} \\
(\beta_0 + \beta_2) + (\beta_3 + \beta_5) w_i & \text{if obs. } i \text{ is in group 3}
\end{cases}
$$
